      ...
      <div>
        ...
        <b-card-group deck>
          ...
          <b-card class="sign" style="max-width: 20rem;" img-src="https://res.cloudinary.com/duvzhauq9/image/upload/v1682514025/ICS_logo.png" img-top>
            <b-card-text>
               This is a member-owned and operated business focused on the arts and not profits. Founded in 1991 by a group of talented Champlain Island crafters
            </b-card-text>
          </b-card>
          ...
          >
            <b-card-text>
              ...
              ICS offers the most innovative products in Vermont.
            </b-card-text>
          </b-card>
        </b-card-group>
