<template>
  ...
  <b-container >
    <div>
      <div>
        ...
        <b-card-group deck>
          ...
          >
            ...
            <cld-image publicId="338352449_610460470946145_6200273633848725717_n_cbixgx.jpg" >
      ...
      <div class="mt-4">
        ...
        <b-card 
        overlay
          img-src="https://res.cloudinary.com/duvzhauq9/image/upload/c_thumb,fl_progressive:steep.text_disallow_overflow,h_900,w_1600/v1682419099/craftshop/033019_4_of_14_dcdxnz.webp"
          img-alt="Card image sign"
          img-left
          class="sign mb-3"
        >
          <b-card-text>
            The shop has grown into a must-see destination for Islanders and visitors alike. 
            Over twenty members now exhibit a wide-ranging array of unique crafts.
          </b-card-text>
        </b-card>
      ...
      <b-card
    overlay
    img-src="https://res.cloudinary.com/duvzhauq9/image/upload/c_limit,h_100,w_150/v1683658398/thread_gifi7f.jpg"
    img-alt="Bannershop"
    text-variant="white"
    title=""
    sub-title=""
  >
    <b-card-text>
            You will find a wonderous assortment of wares such as 
           fiber goods; 
           pottery; 
           fused glass; 
           jewelry;
